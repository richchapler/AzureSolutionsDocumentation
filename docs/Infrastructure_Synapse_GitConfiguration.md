...
* Complete the resulting "**Configure a repository**" pop-out form, including:
  ...
  Prompt | Entry
  ------ | ------
  **Repository Name** | Enter the value appropriate for your instance {e.g., "**AzureSolutions**"}
  **Collaboration branch** | Enter the value appropriate for your instance {e.g., "**development**"}
  **Publish branch** | Confirm default value, "**workspace_publish**"
  **Root folder** | Confirm default value, "**/**"
  **Import existing resource** | Confirm default value, unchecked

* Click **Apply**

  <img src="https://user-images.githubusercontent.com/44923999/185461195-382ecbec-29cf-421b-9f6e-a3380fc577d3.png" width="800" title="Snipped: August 18, 2022" />

* Complete the resulting "**Configure a repository**" pop-out form and then click **Save**

  <img src="https://user-images.githubusercontent.com/44923999/185461479-a6a1af11-8c48-4070-a0d8-eb0cca9a99dc.png" width="800" title="Snipped: August 18, 2022" />
